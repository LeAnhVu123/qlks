...
<div class="col-9">
	...
	<form action="{{route('post.insert-qllp')}}" method="post" enctype="multipart/form-data">
		@csrf
		<div class="row " style="font-size:20px;">
			...
			<div class="col-6 my-2"><input type="file" id="hinhanh" name="hinhanh"></div>
			<div class="offset-1 col-4 my-2">Giá</div>
			<div class="col-6 my-2"><input type="text" id="gia" name="gia" class="form-control"></div>		
		</div>
		<div class="text-center mt-4"><button type="submit" class="btn btn-success btn-lg">Insert12</button></div>
	</form>
</div>
@endsection