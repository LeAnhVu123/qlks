    ...
    <div class="row">
        <div class="col-3">
            <div class="row" style="padding-left:20px;">
                ...
                <div class="col-4">CMND </div><div class="col-8">{{$z->cmnd}}</div>
        ...
        <div class="offset-1 col-3">
            <div class="row">
				...
				@if(!empty($makm))
                <div class="col-12">Khuyến mãi : {{$makm->giagiam}}% </div>
				@endif
        ...
        <div class="col-12"><hr></div>
        <div class="col-5"><span style="float:right;font-weight:bolder;">Chọn hình thức thanh toán</span></div>
        <div class="col-7"><input type="radio" name="tt" id=""> Chuyển khoản</div>
        <div class="col-5"></div>
        <div class="col-7"><input type="radio" name="tt" id=""> Thanh toán trực tiếp</div>
        <div class="col-5"></div>
        <div class="col-7">
			<a href="{{route('addDD')}}"><button class="btn btn-primary">Thanh toán</button></a>
		</div>
    </div>
</div>
